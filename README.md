...
```sh
  git clone https://github.com/huzaifakhan0308/hello-rails-react.git
...
Feel free to check the [issues page](https://github.com/huzaifakhan0308/hello-rails-react/issues).
